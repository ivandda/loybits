    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            className="h-12 min-w-[14rem] gap-2 rounded-2xl border border-white/10 bg-white/70 px-4 py-3 font-bold text-black"
  ...
  return (
    <div className="flex select-none flex-wrap items-stretch justify-center gap-4">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          asChild
          className="rounded-2xl bg-white/70 px-4 py-6 font-bold text-black"
        >
